...
function modChrome_panel($module, $params, $attribs){
	$headerLevel = isset($attribs['headerLevel']) ? (int) $attribs['headerLevel'] : 3;
	if (!empty ($module->content)) { ?>
<div class="panel panel-<?php echo htmlspecialchars($params->get('moduleclass_sfx')); ?>">
 ...
 * @since   3.1
 */
function modChrome_panelforcsiemenu($module, $params, $attribs){
	$headerLevel = isset($attribs['headerLevel']) ? (int) $attribs['headerLevel'] : 3;
	if (!empty ($module->content)) { ?>
<div class="panel panel-<?php echo htmlspecialchars($params->get('moduleclass_sfx')); ?>">
	<?php if ($module->showtitle) { ?>
...
function modChrome_well($module, $params, $attribs){
	$headerLevel = isset($attribs['headerLevel']) ? (int) $attribs['headerLevel'] : 3;
	if (!empty ($module->content)) { ?>
<div class="well<?php echo htmlspecialchars($params->get('moduleclass_sfx')); ?>">
	<?php if ($module->showtitle) { ?>
	<h<?php echo $headerLevel; ?>><?php echo $module->title; ?></h<?php echo $headerLevel; ?>>
	<?php }; ?>
	<?php echo $module->content; ?>
 ...
 * @since   3.1
 */
function modChrome_jumbotron($module, $params, $attribs){
	$headerLevel = isset($attribs['headerLevel']) ? (int) $attribs['headerLevel'] : 3;
	if (!empty ($module->content)) { ?>
<div class="jumbotron<?php echo htmlspecialchars($params->get('moduleclass_sfx')); ?>">
	<?php if ($module->showtitle) { ?>
	<h<?php echo $headerLevel; ?>><?php echo $module->title; ?></h<?php echo $headerLevel; ?>>
	<?php }; ?>
...
/**
 * Jumbotron with container chrome.
 *
 * @since   3.1
 */
function modChrome_jumbotronc($module, $params, $attribs){
	$headerLevel = isset($attribs['headerLevel']) ? (int) $attribs['headerLevel'] : 3;
	if (!empty ($module->content)) { ?>
<div class="jumbotron<?php echo htmlspecialchars($params->get('moduleclass_sfx')); ?>">
	<div class="container">
 ...
 * @since   3.1
 */
function modChrome_pageheader($module, $params, $attribs){
	$headerLevel = isset($attribs['headerLevel']) ? (int) $attribs['headerLevel'] : 3;
	if (!empty ($module->content)) { ?>
<div class="page-header<?php echo htmlspecialchars($params->get('moduleclass_sfx')); ?>">
	<?php if ($module->showtitle) { ?>
	<h<?php echo $headerLevel; ?>><?php echo $module->title; ?></h<?php echo $headerLevel; ?>>
	<?php }; ?>
	<p><?php echo $module->content; ?></p>
 ...
 * @since   3.1
 */
function modChrome_csieDivision($module, $params, $attribs){
	$headerLevel = isset($attribs['headerLevel']) ? (int) $attribs['headerLevel'] : 3;
	if (!empty ($module->content)) { ?>
<div class="csie_panel<?php echo htmlspecialchars($params->get('moduleclass_sfx')); ?>">
<?php if ($module->showtitle) { ?> <h<?php echo $headerLevel; ?>><?php echo $module->title; ?></h<?php echo $headerLevel; ?>>
<?php }; ?> <?php echo $module->content; ?></div>
<?php };
}