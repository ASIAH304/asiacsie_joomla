...
<?php //print_r($list); ?>
<style>
.navbar, .navbar .container{background: <?php echo $background_color; ?> !important;}
.navbar-nav{width: 100%;}
.navbar-nav > li > a{color:<?php echo $text_color; ?> !important;text-shadow: 0 0 0 !important;}
...
.navbar-default .navbar-nav > .active > a, .navbar-default .navbar-nav > .active > a:hover, .navbar-default .navbar-nav > .active > a:focus{background: <?php echo $active_background_color; ?> !important;}
</style>
<?php if($nav_type == 'navbar') : ?>
<nav class="navbar <?php echo $fixed; ?>" role="navigation">
        ...
        ?>
            ...
            <li class="dropdown">
               <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo $item->title; ?> <b class="caret"></b></a>
                    ...
                    <?php foreach ($list as $i => &$subitem) : ?><?php if($subitem->parent_id == $item->id) : ?><li><a href="<?php echo $subitem->flink; ?>"><?php echo $subitem->title; ?></a></li><?php endif; ?>       <?php endforeach; ?>
                    </ul>
            </li>
            <?php endif; ?>
        <?php endforeach; ?>                                                                                           
